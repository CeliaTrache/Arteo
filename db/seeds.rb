...
booking1 = Booking.new(start_time: "19/05/2021", end_time:"20/05/2021" , price: 900, user: user_1, status: "waiting", art_piece: nuit_etoilee)
...
booking2 = Booking.new(start_time: "18/05/2021", end_time:"19/05/2021" , price: 1300, user_id: user_1, status: "validate", art_piece: joconde)
...
booking3 = Booking.new(start_time: "18/05/2021", end_time:"19/05/2021" , price: 700, user_id: user_1, status: "decline", art_piece: creation_adam)
...
booking4 = Booking.new(start_time: "14/05/2021", end_time:"15/05/2021" , price: 800, user_id: user_1, status: "decline", art_piece: red_blue_yellow)
...
booking5 = Booking.new(start_time: "11/05/2021", end_time:"12/05/2021" , price: 500, user_id: user_1, status: "decline", art_piece: bansky)
...
booking6 = Booking.new(start_time: "14/04/2021", end_time:"15/04/2021" , price: 10000, user_id: user, status: "waiting", art_piece: la_cène)
...
booking7 = Booking.new(start_time: "14/06/2021", end_time:"15/06/2021" , price: 300, user_id: user, status: "validate", art_piece: le_desespéré)
...
booking8 = Booking.new(start_time: "11/06/2021", end_time:"12/06/2021" , price: 100, user_id: user_1, status: "validate", art_piece: oreille_bandée)
...
booking9 = Booking.new(start_time: "11/06/2021", end_time:"12/06/2021" , price: 200, user_id: user_1, status: "validate", art_piece: shot_Marilyns)
...
booking10 = Booking.new(start_time: "11/06/2021", end_time:"12/06/2021" , price: 30, user_id: user_1, status: "validate", art_piece: vieil_homme )

evolution = ArtPiece.create(title: "Bansky art evolution", artist: 'Bansky', unit_price: 90, description: "Bansky Art evolution est une oeuvre de street art mettant en avant l'évolution de l'art selon Bansky.", size: "1m10 x 2m10", picture: "https://images-na.ssl-images-amazon.com/images/I/71AQdQ2ZpOL._AC_SX522_.jpg", user: user, category: "Street Art", painting_technic: "Peinture au pochoir")
booking11 = Booking.new(start_time: "11/06/2021", end_time:"12/06/2021" , price: 90, user_id: user, status: "validate", art_piece: evolution)
...
booking12 = Booking.new(start_time: "22/06/2021", end_time:"23/06/2021" , price: 10, user_id: user_1, status: "validate", art_piece: obama)